...
preloading("images/Abby.png", "images/Bert.png", "images/BigBird.png", "images/Elmo.png", "images/Ernie.png", "images/Grover.png", "images/Rosita.png", "images/Zoe.png", "images/airplane.png", "images/apple.png", "images/banana.png", "images/bear.png", "images/bicycle.png", "images/boat.png", "images/bowl.png", "images/brush.png", "images/bunny.png", "images/bus.png", "images/car.png", "images/cat.png", "images/cookie.png", "images/cow.png", "images/cup.png", "images/cupcake.png", "images/dog.png", "images/empty.png", "images/fork.png", "images/horse.png", "images/list.txt", "images/orange.png", "images/pizza.png", "images/plate.png", "images/spoon.png", "images/stanford.png", "images/starOff.png", "images/starOn.png", "images/truck.png", "images/Zoe.png");
//For training:
...
var experiment = {
	...
	next: function(items, trialCond, counter, max, trialType) {
		...
		if (trialCond[counter][2] == "none") {
			var contextPictures = "empty";
		} else if (trialCond[counter][2] == "target") {
			var contextPictures = items[counter][0];
		} else if (trialCond[counter][2] == "foil") {
			var contextPictures = items[counter][1];
		}
		...
		setTimeout(function() {
				...
				$("#nextTrialButton").one('click', function() {
					...
					var result_string = subjectID + "," + trialCond[counter][2] + "," + trialNum + "," + items[counter][0] + "," + trialCond[counter][1] + "," + truthVal + "," + response + "\n";

					//No data collection for demo experiment
					// if (debugMode) {
					// 	alert(result_string); // debug mode 
					// } else {
					// 	$.post("https://langcog.stanford.edu/cgi-bin/AEN2/NEGPAD_felicity_v1/negpad_process.php", {
	...
	background: function() {
		...
		$("#endButton").click(function() {
			...
			if (gen == "" | ag == "" | lan == "") {
				...
				//No data collection for demo experiment
				// $.post("https://langcog.stanford.edu/cgi-bin/AEN2/NEGPAD_felicity_v1/negpad_subject.php", {
